...
to move to the same location and they have the same strength. [none being
supported by another unit].

\paragraph{Support order}
Support order assist another unit's move or hold order. It can either be
used defensively to protect a province against an attack order or increase
the odds of another unit conquering a province. When determining the result
of  
...
If a unit cannot attempt a retreat then the unit is removed from the map by a disband order.
