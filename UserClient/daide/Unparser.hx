...
class Unparser{
    ...
    static function unvariant_option(o:VariantOption):Array<Token>{
        ...
        if(o.val!=null)ret.push((if(o.val==0)tZero else tNonZero(o.val)));
        return ret;
    }
    ...
    static function unturn(t:Turn):Array<Token>return[tPhase(t.phase)].concat([(if(t.turn==0)tZero else tNonZero(t.turn))])static function unorder_list(xs:Array<MsgOrder>):Array<Token>{
        var ret=[];
